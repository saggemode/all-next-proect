...
const ProductDetail = ({ data }) => {
  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center">
        <Row className="container hidden xl:flex">
          <Col span={16} className="p-4">
            <img src={image} className="object-cover h-900 w-full " alt="no img"/>
            <Row className="">
              <Col span={12}>
                <img src={image1} className="object-cover h-500 w-full "alt="no img" />
              </Col>
              <Col span={12}>
          ...
          <Col className="p-4" span={8}>
            ...
            <div className="mt-2 mb-8">
              ...
              {salePrice === price ? (
                ...
                <h1 className="font-light line-through text-sm">
                  ${salePrice}
                </h1>
              )}
            ...
            <div className="my-8">
              ...
              <div className="my-8">
                ...
                <p className="my-2">
                  For any queries, please contact Customer Service at 0803669
                  or via{" "}
      ...
      <Modal
        title={`${cart.length} item(s) added to your cart!`}
        visible={isModalVisible}
        onOk={handleOk}
        onCancel={handleCancel}
      >
        {cart.map((e, index) => (
          <CartModalCover key={index} data={e} />
        ))}
      </Modal>
      <Drawer
        title={`Drawer`}
